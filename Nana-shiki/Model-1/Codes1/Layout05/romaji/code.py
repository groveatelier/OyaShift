...
KC_LOY = L_OYA
KC_ROY = R_OYA
KC_LSPC = KC.LT(4, KC.SPC, tap_time=150)
KC_RSPC = KC.LT(5, KC.SPC, tap_time=150)
KC_LFA = KC.MO(2)
KC_RFB = KC.MO(2)
KC_RFA = KC.MO(2)
KC_RFC = KC.MO(3)
...
keyboard.keymap = [
    ...
    [
        ...
        KC_STAB, KC.S,    KC.F,    KC.Y,    KC.K,    KC.SCLN, KC_LSPC,
        KC.LSFT, KC.X,    KC.V,    KC.H,    KC.COMM, KC.SLSH, KC_ROY,
        KC.LCTL, KC.LWIN, KC_LFA,  KC.N,    KC_RFC,  KC.RALT, KC_RSPC,
    ...
    [
        ...
        KC.TRNS, KC.COMM, KC.EQL,  KC.MINS, KC.N2,  KC.SLSH, KC.TRNS,
        KC.TRNS, KC.TRNS, KC.TRNS, KC.N0,   KC.N0,  KC.EQL,  KC.TRNS,
        KC.TRNS, KC.TRNS, KC.UNDS, KC.TRNS, KC.DOT, KC.TG(1),KC.NO,
        KC.DOT,  KC.TRNS, KC.RPRN, KC.N1,   KC.N3,  KC.TRNS, KC.TRNS,
        KC.TRNS, KC.TRNS, KC.QUOT, KC.N4,   KC.N6,  KC.TRNS, KC.TRNS,
        KC.QUES, KC.TRNS, KC.TRNS, KC.N7,   KC.N9,  KC.TRNS, KC.TRNS
    ],
    ...
    [
        ...
        KC_STAB, KC_SI,   KC_KE,   KC_RA,   KC_KI,   KC_NN,   KC_LSPC,
        KC_FSFT, KC_HI,   KC_HU,   KC_HA,   KC_NE,   KC.SLSH, KC_ROY,
        KC_FCTL, KC_FWIN, KC.TRNS, KC_ME,   KC_FFC,  KC_FALT, KC_RSPC,
        KC_FALT, KC.SPC,  KC_HE,   KC.TRNS, KC.RSFT, KC_FCTL, KC.NO,
